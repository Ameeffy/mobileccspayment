...
const UserPreOrderProofOfPayment = () => {
    ...
    const handleUploadProof = async () => {
        ...
        try {
            ...
            const response = await fetch('https://finalccspayment.onrender.com/api/auth/update-preorder-proof', {
                method: 'POST',
                headers: {
            ...
            {infoModalVisible && (
                          <View style={styles.infoModal}>
                            <View style={styles.infoModalContent}>
                              ...
                              Please scan the QR code to pay the exact amount of your pre-order. After payment, upload your proof of payment. Thank you!
                              </Text>
                              <TouchableOpacity
